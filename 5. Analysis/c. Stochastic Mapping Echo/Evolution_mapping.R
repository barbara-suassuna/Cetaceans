...
# --- Read Tree file ---#
tree <- read.tree ("supermatrix_data1.fasta.treefile")
tree$tip.label
#Re-root the tree
root.tree<- root(tree, outgroup = "Hippopotamus_amphibius", resolve.root = TRUE)
...
head(n.changes,30) #looks at first 60 trees' summary of changes
